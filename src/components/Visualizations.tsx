...
export const getVisualization = (id: string) => {
  const visualizations: Record<string, React.FC<VisualizationProps>> = {
    ...
    "vertical-scaling": VerticalScalingViz,
    "caching": CachingViz,
    ...
    "timeout-pattern": TimeoutPatternViz,
    ...
    "leader-election": LeaderElectionViz,
    "consensus": ConsensusViz,
    "gossip-protocol": GossipProtocolViz,
    "read-replica": ReadReplicaViz,
    "write-through-cache": WriteThroughCacheViz,
    "write-behind-cache": WriteBehindCacheViz,
    "cache-aside": CacheAsideViz,
    "pub-sub": PubSubViz,
    "request-response": RequestResponseViz,
    "reverse-proxy": ReverseProxyViz,
    "connection-pooling": ConnectionPoolingViz,
    "data-partitioning": DataPartitioningViz,
    "throttling": ThrottlingViz,
    "dns-load-balancing": DNSLoadBalancingViz,
    "zero-trust": ZeroTrustViz,
  };
